...
import static org.mazarineblue.utililities.util.TestUtil.assertRegex;

/**
 * @author Alex de Kruijff <alex.de.kruijff@MazarineBlue.org>
 */
@RunWith(HierarchicalContextRunner.class)
public class ConsoleRunnerPluginTest {
    ...
    public class TestMetaData {
        ...
        @Before
        public void setup() {
            plugin = new ConsoleRunnerPlugin();
        }

        @Test
        public void testName() {
            assertEquals("console", plugin.name());
        }
    ...
    public class TestWithFileSystem {
        ...
        public class TestConsoleRunner {
            ...
            @Before
            public void setup() {
                plugin = new ConsoleRunnerPlugin(fs);
                cli = (ConsoleRunner) plugin.createRunner();
            }
            ...
            public void nullArguments_HelpPrinted() {
                ...
                String expected = String.format(format, ConsoleRunnerPlugin.APP, ConsoleRunnerPlugin.NAME);
        ...
        public class SpecialCases {
            ...
            public void fileSystemUnreadable() {
                plugin = new ConsoleRunnerPlugin(new WriteOnlyFileSystem(fs));
                cli = (ConsoleRunner) plugin.createRunner();
            ...
            public void fileSystemUnwritable() {
                plugin = new ConsoleRunnerPlugin(new ReadOnlyFileSystem(fs));
                cli = (ConsoleRunner) plugin.createRunner();
                cli.execute(PROPER_FILE);
                String format = "INFO: Started" + lineSeparator()
                        + "INFO: Processing feed: " + PROPER_FILE + lineSeparator()
                ...
                String regex = String.format(format, ConsoleRunnerPlugin.APP, ConsoleRunnerPlugin.NAME, LOG_FILE);
