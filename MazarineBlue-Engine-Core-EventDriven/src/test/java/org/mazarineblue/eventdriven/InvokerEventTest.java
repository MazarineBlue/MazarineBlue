...
import static org.mazarineblue.eventbus.Event.Status.ERROR;
...
public class InvokerEventTest {
    ...
    public void event_Fired() {
        ...
        assertEquals(
                "error=Unconsumed event org.mazarineblue.eventdriven.util.TestInvokerEvent with value: consumed=false",
                spy.message());
    }
}
