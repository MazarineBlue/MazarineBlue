...
public class FeedExecutorListenerListTest
    ...
    private FeedExecutorListenerSpy spy1, spy2;
    ...
    @Before
    public void setup() {
        spy1 = new FeedExecutorListenerSpy(matchesNoneAutoConsumable());
        spy2 = new FeedExecutorListenerSpy(matchesNoneAutoConsumable());
