...
public class ValidateInstructionLineEvent
    ...
    public String toString() {
        return "line={" + super.toString() + "}, flags={" + flagsToString() + "}, customFlags=" + customFlags;
    }

    @Override
    public String responce() {
        return "flags={" + flagsToString() + "}, customFlags=" + customFlags;
    }
    ...
    /**
     * Changes the state of this {@code Event} to indicate that there where too
