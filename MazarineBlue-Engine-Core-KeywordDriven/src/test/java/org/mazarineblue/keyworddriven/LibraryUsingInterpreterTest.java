...
public class LibraryUsingInterpreterTest {
    ...
    public class EmptyLink {
        ...
        public void validate_EmptyLink_UnregistedNamespace_DoesntValidate() {
            ValidateInstructionLineEvent e = new ValidateInstructionLineEvent(
            ...
            assertEquals(0, e.getUserErrorFlags());
        }
        ...
        public void validate_EmptyLink_NonExistingInstruction_DoesntValidate() {
            ValidateInstructionLineEvent e = new ValidateInstructionLineEvent(NO_NAMESPACE_ZERO_ARGUMENTS_INSTRUCTION);
            feed.add(e);
            interpreter.execute(feed);
            assertFalse(e.isValid());
            assertFalse(e.isArgumentsAreIncompatible());
    ...
    public class EmptyLibrary {
        ...
        public void validate_EmptyLibrary_NonExistingInstruction_DoesntValidate() {
            ValidateInstructionLineEvent e = new ValidateInstructionLineEvent(NO_NAMESPACE_NON_EXISTING_INSTRUCTION);
            feed.add(e);
            interpreter.execute(feed);
            assertFalse(e.isValid());
            assertFalse(e.isArgumentsAreIncompatible());
    ...
    public class FilledLibrary {
        ...
        public void validate_FilledLibrary_ZeroArgumentsInstruction_Integer_DoesValidate() {
            ValidateInstructionLineEvent e = new ValidateInstructionLineEvent(NO_NAMESPACE_ZERO_ARGUMENTS_INSTRUCTION, 1);
            feed.add(e);
            interpreter.execute(feed);
        ...
        public void validate_FilledLibrary_OneArgumentInstruction_Void_DoesntValidate() {
            ValidateInstructionLineEvent e = new ValidateInstructionLineEvent(NO_NAMESPACE_ONE_ARGUMENT_INSTRUCTION);
            feed.add(e);
            interpreter.execute(feed);
            assertFalse(e.isValid());
            assertFalse(e.isArgumentsAreIncompatible());
