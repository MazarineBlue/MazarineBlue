...
public class FeedExecutorBuilderTest {
    ...
    private FeedExecutorBuilder builder;

    @Before
    public void setup() {
        builder = new FeedExecutorBuilder();
    }
    ...
    public void getOutput_BaseLine() {
        assertEquals(FeedExecutorOutput.getDummy(), builder.getOutput());
    }

    @Test
    public void setOutput() {
        FeedExecutorOutput output = new FeedExecutorOutputSpy();
        builder.setOutput(output);
        assertEquals(output, builder.getOutput());
    }
}
