...
/**
 * A {@code AddChainModifierListenerEvent} is an event that signals to
 * {@link EngineLogger} to register the contained listener to the notified
 * list.
 *
 * @author Alex de Kruijff <alex.de.kruijff@MazarineBlue.org>
 */
public class AddChainModifierListenerEvent
        extends AbstractChainModifierListenerEvent {

    private static final long serialVersionUID = 1L;

    /**
     * Constructs a {@code AddChainModifierListenerEvent} to request to register
     * the specified listener.
     *
     * @param listener the listener to register.
     */
    public AddChainModifierListenerEvent(ChainModifierListener listener) {
        super(listener);
    }
}
