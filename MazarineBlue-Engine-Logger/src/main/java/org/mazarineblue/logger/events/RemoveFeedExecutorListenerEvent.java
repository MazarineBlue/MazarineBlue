...
/**
 * A {@code RemoveFeedExecutorListenerEvent} is an event that signals to
 * {@link EngineLogger} to unregister the contained listener to the notified
 * list.
 *
 * @author Alex de Kruijff <alex.de.kruijff@MazarineBlue.org>
 */
public class RemoveFeedExecutorListenerEvent
        extends AbstractFeedExecutorListenerEvent {

    private static final long serialVersionUID = 1L;

    /**
     * Constructs a {@code RemoveFeedExecutorListenerEvent} to request to register
     * the specified listener.
     *
     * @param listener the listener to register.
     */
    public RemoveFeedExecutorListenerEvent(FeedExecutorListener listener) {
        super(listener);
    }
}
