...
public class SkipEventsSubscriberTest
    ...
    protected SkipEventsSubscriber createRecordingWithContent(String invoker, String stopCondition, TestEvent... events) {
        ...
        SkipEventsSubscriber skipEvents = new SkipEventsSubscriber(new TestInvoker(processor).setIdentifier(invoker), new PredicateIdentifierWrapper<Event>((t) -> false).setIdentifier(stopCondition));
