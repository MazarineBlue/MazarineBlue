...
public class VariableStoreLibrary
        extends Library {

    private static final String NAMESPACE = "org.mazarineblue";

    private final Deque<VariableStore> stack = new ArrayDeque<>(16);

    public VariableStoreLibrary() {
        super(NAMESPACE);
    ...
    public boolean equals(Object obj) { // @TODO write tests.
        return this == obj || obj != null && getClass() == obj.getClass()
                && this.stack.size() == ((VariableStoreLibrary) obj).stack.size()
                && equals((VariableStoreLibrary) obj);
    }

    private boolean equals(VariableStoreLibrary other) {
