...
public class CloneTest {
    ...
    @Test
    public void clone_SymbolVariableEvent() {
        Event e = new SetVariableEvent("symbol", "value");
        assertEquals(e, Event.clone(e));
    }

    @Test
    public void clone_GetGlobalVariableStoreEvent() {
    ...
    @Test
    public void clone_SetGlobalVariableStoreEvent() {
        SetGlobalVariableStoreEvent e = new SetGlobalVariableStoreEvent(new RegularVariableStore("foo"));
        assertEquals(e, Event.clone(e));
    }
}
