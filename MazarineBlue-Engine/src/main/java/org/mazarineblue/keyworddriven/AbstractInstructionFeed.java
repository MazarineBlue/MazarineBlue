...
public abstract class AbstractInstructionFeed
    ...
    protected Event createEvent(String path, Object... arguments) {
        switch (mode) {
            case EXECUTING: return createExecuteInstructionLineEvent(path, arguments);
            case VALIDATING: return createValidateInstructionLineEvent(path, arguments);
            default: throw new NeverThrownException();
        }
    }
