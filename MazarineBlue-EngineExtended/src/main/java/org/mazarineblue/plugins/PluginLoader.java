 ...
 *
 * <p>
 * The JAR file must have a directory src/main/resources/META-INF/service.
 * Within that directory, there must be a file named org.mazarineblue.plugins.Plugin.
 * Within this file, all plugins must be listed, using a new line for each plugin.
 *
