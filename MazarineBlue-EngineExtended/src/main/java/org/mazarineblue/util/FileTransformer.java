...
public interface FileTransformer {
    ...
    public static FileTransformer getDefaultInstance() {
        return getDefaultInstance(DateFactory.getDefaultInstance());
    }

    public static FileTransformer getDefaultInstance(DateFactory dateFactory) {
