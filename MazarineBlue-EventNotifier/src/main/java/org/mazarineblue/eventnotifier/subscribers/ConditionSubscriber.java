...
/**
 * A {@code ConditionLink} is a {@code Subscriber} that represents a condition
 * that accepts a event.
 *
 * @author Alex de Kruijff <alex.de.kruijff@MazarineBlue.org>
 */
public abstract class ConditionSubscriber<E extends Event>
     ...
     */
    protected ConditionSubscriber(Predicate<E> condition) {
     ...
     */
    protected boolean applyCondition(E event) {
