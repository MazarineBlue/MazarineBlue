...
public class DefaultProcessor
    ...
    public DefaultProcessor(FeedBuilder feedBuilder, LogBuilder logBuilder) {
        super(feedBuilder);
        Library library = createDefaultLibrary(logBuilder);
        libraries().register(library);
    }

    private Library createDefaultLibrary(LogBuilder logBuilder) {
        DefaultLibrary library = new DefaultLibrary(managerFacade.eventService(), procedures());
        library.setLogBuilder(logBuilder);
        return library;
    }
}
