 ...
 */
public class DoLoopLibraryLink
        extends RecordingLibraryLink {

    private final LoopTester loopTester;

    public DoLoopLibraryLink(Library library, LoopTester loopTester) {
        super(library);
    ...
    @Keyword("End do")
    @Parameters(min = 1)
    public void endDo(String expression) {
    ...
    public void eventHandler(EndSheetEvent event) {
        throw new BlockOpenOnEndSheetException("Do lus", event.getSheetName());
    }
}
