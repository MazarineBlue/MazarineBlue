...
public class EmailLibraryPlugin
        extends AbstractLibraryPlugin {

    static final String NAMESPACE = "org.mazarineblue.libraries.email";

    public EmailLibraryPlugin() {
        super(NAMESPACE);
    }
    ...
    protected List<Library> doLibraries() {
        ...
        return asList(new EmailLibrary(session));
    }
}
