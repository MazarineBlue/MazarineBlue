...
public class FixtureLoaderLibraryPlugin
        implements LibraryPlugin {

    @Override
    public boolean canHandle(String namespace) {
        return namespace.equals(FixtureLoaderLibrary.NAMESPACE);
    }

    @Override
    public List<Library> getLibraries(String namespace) {
        return namespace.equals(FixtureLoaderLibrary.NAMESPACE) ? getLibraries()
                : Collections.emptyList();
    }

    private List<Library> getLibraries() {
        return asList(new FixtureLoaderLibrary());
    }
}
