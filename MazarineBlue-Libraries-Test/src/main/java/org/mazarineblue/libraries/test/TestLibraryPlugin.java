...
public class TestLibraryPlugin
    ...
    public boolean canHandle(String namespace) {
        return namespace.equals(AbstractTestLibrary.NAMESPACE);
    }

    @Override
    public List<Library> getLibraries(String namespace) {
        return namespace.equals(AbstractTestLibrary.NAMESPACE) ? getLibraries()
                : Collections.emptyList();
    }

    private List<Library> getLibraries() {
        return asList(AbstractTestLibrary.getInitialLibrary());
    }
}
