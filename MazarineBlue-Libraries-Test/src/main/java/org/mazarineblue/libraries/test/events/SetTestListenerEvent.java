...
public class SetTestListenerEvent
        extends AbstractEvent {

    private static final long serialVersionUID = 1L;

    private transient TestListener listener;

    public SetTestListenerEvent(TestListener listener) {
    ...
    @Override
    public int hashCode() {
        return 29 * 3 + Objects.hashCode(this.listener);
    }

    @Override
    public boolean equals(Object obj) {
        return this == obj || obj != null && getClass() == obj.getClass()
                && Objects.equals(this.listener, ((SetTestListenerEvent) obj).listener);
    }

    @Override
    public <E extends SerializableClonable> void copyTransient(E other) {
        super.copyTransient(other);
        listener = ((SetTestListenerEvent) other).listener;
    }
}
