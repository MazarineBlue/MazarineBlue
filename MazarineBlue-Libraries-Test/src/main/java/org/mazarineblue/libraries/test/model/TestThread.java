...
class TestThread
    ...
    private final FeedExecutor executor;
    private final Test test;
    private final Semaphore lock;
    private TestListener listener = TestListener.getDummy();

    TestThread(FeedExecutor executor, Test test, Semaphore lock) {
    ...
    private MemoryFeed createFeed(Test test) {
        MemoryFeed feed = new MemoryFeed(new AddLibraryEvent(new RuntimeTestLibrary(test)));
