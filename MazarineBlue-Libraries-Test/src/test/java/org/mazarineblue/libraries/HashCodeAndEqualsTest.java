...
import org.mazarineblue.libraries.test.MainTestLibrary;
...
import org.mazarineblue.libraries.util.SuiteStub;
import org.mazarineblue.libraries.util.TestListenerSpy;
import org.mazarineblue.libraries.util.TestStub;
...
public class HashCodeAndEqualsTest {
    ...
    @SuppressWarnings("PublicInnerClass")
    public class GetTestResultHCAE
            extends TestHashCodeAndEquals<GetTestResultEvent> {

        @Override
        protected GetTestResultEvent getDifferentObject() {
            return new GetTestResultEvent();
        }

        @Override
        protected GetTestResultEvent getObject() {
        ...
        @org.junit.Test
        public void hashCode_DifferentFailedCount()
                throws Exception {
            int a = getObject().hashCode();
            int b = getDifferentFailedCount().hashCode();
            assertNotEquals(a, b);
        }

        @org.junit.Test
        public void equals_DifferentFailedCount()
                throws Exception {
            Object a = getObject();
            Object b = getDifferentFailedCount();
            assertFalse(a.equals(b));
        }

        private Object getDifferentFailedCount() {
            GetTestResultEvent e = new GetTestResultEvent();
            e.setTests(1);
            e.setFailedTests(1);
            return e;
        ...
        @org.junit.Test
        public void hashCode_DifferentTestCount()
                throws Exception {
            int a = getObject().hashCode();
            int b = getDifferentTestCount().hashCode();
            assertNotEquals(a, b);
        }

        @org.junit.Test
        public void equals_Differe1ntTestCount()
                throws Exception {
            Object a = getObject();
            Object b = getDifferentTestCount();
            assertFalse(a.equals(b));
        }

        private Object getDifferentTestCount() {
            GetTestResultEvent e = new GetTestResultEvent();
            e.setTests(2);
            return e;
        }
    ...
    public class SetTestListenerEventHCAE
        ...
        protected SetTestListenerEvent getDifferentObject() {
            return new SetTestListenerEvent(new TestListenerSpy());
        }
    ...
    public class RuntimeTestLibraryHCAE
        ...
        protected RuntimeTestLibrary getObject() {
            return new RuntimeTestLibrary(createTest("global", "local", "name"));
        }

        @Override
        protected RuntimeTestLibrary getDifferentObject() {
            return new RuntimeTestLibrary(createTest("global", "local", "foo"));
        }
        ...
        private Object getDifferentGlobalSuite() {
            return new RuntimeTestLibrary(createTest("foo", "local", "name"));
        }
        ...
        private Object getDifferentLocalSuite() {
            return new RuntimeTestLibrary(createTest("global", "foo", "name"));
        }
    }
