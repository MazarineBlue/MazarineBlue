...
public class EdgeSetupLibrary
        extends AbstractCapabilitiesLibrary<EdgeOptions> {

    EdgeSetupLibrary(BrowserRegistry manager) {
        super(manager, new EdgeOptions());
    }
    ...
    public void start(Invoker invoker, String browserName, String initialTabName) {
        ...
        startBrowser(invoker, createBrowser(new EdgeDriver(getOptions()), browserName, initialTabName));
    }
}
