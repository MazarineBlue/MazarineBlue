...
public class InternetExplorerSetupLibrary
        extends AbstractMutableCapabilitiesLibrary<InternetExplorerOptions> {

    public InternetExplorerSetupLibrary(BrowserRegistry manager) {
        super(manager, new InternetExplorerOptions());
    }
    ...
    public void start(Invoker invoker, String browserName, String initialTabName) {
        ...
        startBrowser(invoker, createBrowser(new InternetExplorerDriver(getOptions()), browserName, initialTabName));
    }
}
