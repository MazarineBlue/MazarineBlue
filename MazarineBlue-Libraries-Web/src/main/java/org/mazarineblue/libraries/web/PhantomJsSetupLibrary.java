...
public class PhantomJsSetupLibrary
        extends AbstractDesiredCapabilitiesLibrary {

    public PhantomJsSetupLibrary(BrowserRegistry manager) {
        super(manager);
    }
    ...
    public void start(Invoker invoker, String browserName, String initialTabName) {
        startBrowser(invoker, createBrowser(new PhantomJSDriver(getOptions()), browserName, initialTabName));
    }
}
