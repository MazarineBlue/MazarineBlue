 ...
 * {@link ProcedureLink} when a {@link StartRecordingProcedureEvent} was
 * published twice in a row.
 *
 * @author Alex de Kruijff <alex.de.kruijff@MazarineBlue.org>
 */
@Immutable
public class StartRecordingProcedureFirstException
        extends ProcedureException {

    private static final long serialVersionUID = 1L;

    public StartRecordingProcedureFirstException() {
        super();
    }
}
