...
import org.mazarineblue.procedures.events.ProcedureEvent;

public class ProcedureEventTest {

    private ProcedureEvent a;

    @Before
    public void setup() {
        a = new CallProcedureEvent("foo");
    }
    ...
    public void hashCode_DifferentContent() {
        ProcedureEvent b = new CallProcedureEvent("oof");
    ...
    public void hashCode_IdenticalContent() {
        ProcedureEvent b = new CallProcedureEvent("foo");
