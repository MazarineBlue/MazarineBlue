 ...
 */
public class UniqueCollectionObjectMatcher<T>
        implements CollectionObjectMatcher<T> {
     ...
     */
    public UniqueCollectionObjectMatcher(ValidationLabelSwitcher switcher) {
        this.switcher = switcher;
    }

    @Override
    public boolean match(Collection<T> collection, Object selected) {
        boolean nonMatch = selected == null || collection.stream().noneMatch(selected::equals);
