...
public class Implies
    ...
    Implies(Object left, Object right) {
        super(left, "->", right);
    }

    @Override
    public Boolean evaluateBoolean() {
        return getLeftExpression().evaluateBoolean() ? getRightExpression().evaluateBoolean() : true;
    }

    @Override
    public Expression not() {
        return implies(getRightExpression().not(), getLeftExpression().not());
    }
