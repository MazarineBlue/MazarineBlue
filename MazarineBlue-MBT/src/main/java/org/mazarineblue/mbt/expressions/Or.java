...
public class Or
    ...
    public Expression not() {
        return and(getLeftExpression().not(), getRightExpression().not());
    }

    @Override
    public List<Expression> getTerms() {
        List<Expression> list = new ArrayList<>(getLeftExpression().getTerms());
        list.addAll(getRightExpression().getTerms());
        return list;
    }
