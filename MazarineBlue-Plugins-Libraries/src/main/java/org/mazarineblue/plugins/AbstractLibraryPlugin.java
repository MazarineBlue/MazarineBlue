...
public abstract class AbstractLibraryPlugin
        implements LibraryPlugin {

    private final String namespace;

    protected AbstractLibraryPlugin(String namespace) {
    ...
    public List<Library> getLibraries(String namespace) {
        return this.namespace.equals(namespace) ? doLibraries() : emptyList();
    }

    protected abstract List<Library> doLibraries();
}
