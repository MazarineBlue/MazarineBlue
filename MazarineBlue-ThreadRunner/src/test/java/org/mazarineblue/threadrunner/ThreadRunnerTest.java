...
import org.mazarineblue.threadrunner.events.KillEvent;
import org.mazarineblue.threadrunner.exceptions.TimeoutException;
import org.mazarineblue.threadrunner.util.WaitingFeedExecutor;
...
public class ThreadRunnerTest {
    ...
    public class RunnerInWaitForEverMode {
        ...
        private void startRunnerInWaitForEverMode()
                throws InterruptedException {
            FeedExecutorFactory factory = new TestFeedExecutorFactory(new WaitingFeedExecutor());
